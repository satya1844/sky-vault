...
export default function FolderNavigation({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 text-sm overflow-x-auto pb-2 cursor-pointer">
      <Button
        variant="flat"
        size="sm"
        isIconOnly
      ...
      <Button
        ...
        className={folderPath.length === 0 ? "font-bold cursor-pointer " : "cursor-pointer"}
      >
        Home
      </Button>
